        ...
        <div class="media__container container">
            <div class="media__block-header">
                ...
                if ($blog_las_link):
                    ...
                    ?>
                    <a class="media__block-all" href="<?php echo esc_url($link_url); ?>"
                ...
                <div class="swiper-wrapper">
                    <?php foreach ($blog_sliders as $blog) : ?>
                        ...
                        <a href="<?php the_permalink($blog->ID); ?>"
                           class="article-card <?php echo $blog_las_card_class; ?>">
                            <picture class="article-card__image">
                                <img src="<?php echo get_the_post_thumbnail_url($blog->ID, 'full'); ?>" alt="thumb"
                                     loading="lazy">
                            </picture>
